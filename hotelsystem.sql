...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2021 at 02:00 PM
...
(132, 15, 9809876543, 'Sanothimi', 'female', '1994-02-02', 31, 3, '2021-09-25', 21000, 'card_1JcUu0SAqwIwgmCpbbMPfwVz', '2021-09-22', 1);
...
--
ALTER TABLE `cancellations`
  MODIFY `CANCEL_ID` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `rooms`
  MODIFY `ROOM_ID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

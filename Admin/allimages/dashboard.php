        ...
        <div class="row">
          ...
          <p class="name"> HOTEL DREAM</p>
           ...
           <div class="sidenav">
            ...
            <a href="image.php"><i class="fa fa-fw fa-image"></i>Images</a>
            <a href="../allcustomers/customer.php"><i class="fa fa-fw fa-users"></i>Customers</a>
            <a href="../contact.php"><i class="fa fa-fw fa-envelope"></i>Contact</a>
            <a href="../allcustomers/detail.php">Customer Report</a>
            <!-- <a href="../allcustomers/payment.php">Payment Report</a> -->
        </div>
        </div>
      </div>
    </div>
